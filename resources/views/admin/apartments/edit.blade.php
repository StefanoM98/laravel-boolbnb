                        ...
                        <form action="{{ route('admin.apartments.update', $apartment->slug) }}" method="POST"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    id="name" name="name" value="{{ $apartment->name }}">
                                @error('name')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control @error('bed_number') is-invalid @enderror"
                                    id="bed_number" name="bed_number" value="{{ $apartment->bed_number }}">
                                @error('bed_number')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control @error('bathroom_number') is-invalid @enderror"
                                    id="bathroom_number" name="bathroom_number" value="{{ $apartment->bathroom_number }}">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control @error('room_number') is-invalid @enderror"
                                    id="room_number" name="room_number" value="{{ $apartment->room_number }}">
                                @error('room_number')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('address') is-invalid @enderror"
                                    id="address" name="address" value="{{ $apartment->address }}" autocomplete="off"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('city') is-invalid @enderror"
                                    id="city" name="city" value="{{ $apartment->city }}">
                                @error('city')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('state') is-invalid @enderror"
                                    id="state" name="state" value="{{ $apartment->state }}">
                                @error('state')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="file" class="form-control @error('image') is-invalid @enderror"
                                    id="image" name="image" value="{{ $apartment->image }}" max="5242880">
                                @error('image')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                @if ($apartment->image)
                                    <div class="mt-3">
                                        <img class="w-50" id="img-prev"
                                            src="{{ asset('storage/' . $apartment->image) }}"
                                            alt="{{ $apartment->name }}">
                                    </div>
                                @endif
                                <div class="mt-3">
                                    <img class="d-none w-25" id="image-preview" src=""
                                        alt="{{ $apartment->name }}">
                                </div>
                            </div>
                        ...
                        li.addEventListener('click',
                            () => {
                                ...
                                if (currentValue.address.streetNumber) {
                                    search.value = currentValue.address.streetName + ", " + currentValue
                                        .address.streetNumber + ", " + currentValue.address.postalCode;
                                } else {
                                    search.value = currentValue.address.streetName + ", " + currentValue
                                        .address.postalCode;
                                }
